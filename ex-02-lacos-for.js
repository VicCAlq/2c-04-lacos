...
export const resposta02 = contador02
...
export const resposta04 = soma04 / qtd04
...
for (let i = 0; i < itensDomesticos.length; i++) {
  if (itensDomesticos[i].startsWith("c")) lista05.push(itensDomesticos[i]);
}
export const resposta05 = lista05
...
let lista06 = [];
for (let i = 0; i < itensDomesticos.length; i++) {
  if (i % 2 !== 0) lista06.push(itensDomesticos[i]);
}
export const resposta06 = lista06
...
let lista07 = [];
for (let i = 0; i < itensDomesticos.length; i++) {
  if (itensDomesticos[i].length > 6) lista07.push(itensDomesticos[i]);
}
...
for (let i = itensDomesticos.length - 1; i >= 0; i--) {
  lista08.push(itensDomesticos[i]);
}

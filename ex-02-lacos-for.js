...
for (let pet of petsExoticos) {
  respostarrw.push(pet.toUpperCase())
}
...
for (let pet of petsExoticos) {
  if (pet.includes("r")) {
    respostarrw.push(pet)
  }
}

export const resposta10 = respostarrw
...
export const resposta11 = respostarrw

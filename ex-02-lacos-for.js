...
export const resposta02 = contagemImpares;
...
export const resposta04 = somaM3 / qtdM3;
...
/* Questão 06
Utilizando a mesma lista de itens domésticos, use um laço de repetição for (com contador) 
para criar um novo array contendo apenas os itens que estão nos índices ímpares 
da lista original. Armazene o novo array na variável resposta06.
*/
...
/* Questão 08
Finalizando com a lista de itens domésticos, use um laço de repetição for 
...
variável resposta11.
*/
let contagemPets7Letras = 0;
for (let pet of petsExoticos) {
  if (pet.length > 7) {
    contagemPets7Letras++;
  }
}
export const resposta11 = contagemPets7Letras;
